...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Smart-Refactor.git`
...
```bash
# Clone the repo
git clone https://github.com/Qyroxen/Smart-Refactor.cd

# Install dependencies
go mod download

# Build
go build -o smartrefactor .
